...
{
    // Reference used for NSLogging demo on line below
    SMKDebugWidget* SMKDebug __attribute__((unused)) = [SMKDebugWidget addToWindow:self.window];
    
    [SMKDebug enableLogging]; //Uncomment for logging
